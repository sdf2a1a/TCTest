#
#  Be sure to run `pod spec lint TCTest.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.source       = { :git => "https://github.com/sdf2a1a/TCTest.git", :tag => "#{spec.version}" }
  ...
  spec.resources = "LearnEnglish/LearnEnglish/test/*.{xib,png}"
